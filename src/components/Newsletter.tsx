  ...
  return <section className="bg-background">
      <div className="grid md:grid-cols-2">
        ...
        <div className="relative min-h-[500px] md:min-h-[600px]">
          <img src={newsletterImage} alt="Dionne Tweneboah" className="absolute inset-0 w-full h-full object-cover" />
          {/* Overlay gradient */}
          ...
          <div className="absolute inset-0 flex flex-col justify-between p-8 md:p-12 text-white">
            ...
            <div className="space-y-4">
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-[#992430]">
        ...
        <div className="bg-white flex items-center justify-center p-8 md:p-12 lg:p-16">
          <div className="w-full max-w-md space-y-8">
            ...
            <div className="space-y-6">
              <Input type="email" placeholder="Your email" className="h-14 rounded-full border-muted-foreground/30 px-6 text-base" />
